#############################################################################
# Makefile for building: QtSvg
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? 3? 30 11:37:45 2016
# Project:  svg.pro
# Template: lib
# Command: f:\Qt\4.8.7\bin\qmake -o Makefile svg.pro
#############################################################################
...
Makefile: svg.pro ..\..\.qmake.cache ..\..\mkspecs\win32-msvc2010\qmake.conf ..\..\mkspecs\features\exclusive_builds.prf \
		...
		..\..\include\QtSvg\headers.pri \
		..\qt_install.pri \
		..\qt_targets.pri \
		..\qbase.pri \
		..\3rdparty\zlib_dependency.pri \
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) "tmp\obj\debug_shared\QtSvg.intermediate.manifest"
	-$(DEL_FILE) ..\..\lib\QtSvg4.exp
	-$(DEL_FILE) ..\..\lib\QtSvg4.ilk
	-$(DEL_FILE) vc*.pdb
	-$(DEL_FILE) vc*.idb
distclean: debug-distclean release-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) ..\..\lib\QtSvg4.pdb
